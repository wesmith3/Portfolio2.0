  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[90vw] max-w-lg relative rounded-2xl border flex-shrink-0 border-orange p-5 md:p-16 py-6 md:w-[60vw]"
            style={{
              background: 'slate-800',  
              backgroundColor:
                'linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(92,62,21,1) 35%, rgba(255,156,0,1) 100%)',
            }}
            key={idx}
          >
            <blockquote>
